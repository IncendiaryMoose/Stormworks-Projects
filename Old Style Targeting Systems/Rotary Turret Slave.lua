require("Clamp")
--[-0.5,0][-0.4,0.02][-0.35,0.025][-0.3,0.02][-0.25,-0.00125][0,0][0.25,-0.00125][0.3,0.02][0.35,0.025][0.4,0.02][0.5,0]
...
function onTick()
	...
	outputNumbers[1] = desiredPitch * 4
