...
function floatToBinary(float, exponentBits, mantissaBits, binaryTable)
    ...
    local exponent, bias, startIndex, mantissa, factor = floor(log(float, 2)), 2 ^ exponentBits / 2 - 1, #binaryTable -- Determine what exponent is needed, and how much to offset it (based on the bits allocated to it)
