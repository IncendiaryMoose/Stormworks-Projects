...
require("Vector_Math")
require("In_Out")
require('Deprecated_Radar_Mass_Target_Manager')
maxError = 20
maxMemory = 5
maxAge = 30
...
function onTick()
	...
	massNumber = input.getNumber(30)*100000000 + input.getNumber(31)
...
function onDraw()
	for l, targetData in pairs(oldTargetGroup) do
		...
		screen.drawText(clamp(positionScreenX, 51, w-50), clamp(positionScreenY, 5, h-4), targetData.mass)
	end
end
